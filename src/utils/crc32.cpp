...
#define STEP4W(w)                                   \
  ...
  if ((e - p) >= 16) {
    ...
    // 通过交错处理有可能获得更好的速度（至少在x86上）。
    // 预取256个字节和一次处理64个字节。请看
    // https://github.com/google/crc32c/ 中的//可移植实现。
